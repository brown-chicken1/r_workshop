...
5ba. When dealing with line data, such as in the case of the road layer, there are some roads which may be disjointed or incomplete. To fix this, follow the section below "Data processing with line data".
...
1. In the raw data gis_osm_roads_free_1.shp 
