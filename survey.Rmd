...
## 4.3 Infrastructure - Water Supply (Distributers)
...
The study analyzes the location and distribution of water supply (distributers) in the Study Area. We should pick an area that is accessible to water supply to keep operations running.
